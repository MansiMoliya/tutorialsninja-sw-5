...
import com.tutorialsninja.demo.resources.testdata.TestData;
...
public class AccountRegisterPageTest extends BaseTest {
    ...
    @Test(groups = {"sanity", "regression","smoke"},dataProvider = "credentials", dataProviderClass = TestData.class)
